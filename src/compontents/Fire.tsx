...
// 1) ShaderMaterial con snoise inline
...
export const Fire = forwardRef(({ color, ...props }, ref) => {
    ...
    useFrame((state) => {
        ...
        mat.uniforms.invModelMatrix.value
            .copy(meshRef.current.matrixWorld)
            .invert();
        mat.uniforms.scale.value = meshRef.current.scale;
    });
    ...
    useLayoutEffect(() => {
        ...
        mat.uniforms.color.value = color || new THREE.Color(0xeeeeee);
